...
public class Wizzard4 extends AbstractWin implements Runnable {
    ...
    private void initComponents() {
        ...
        label1.setText("The Gateway is rebooting for the configuration to take effect. It takes about 10 seconds. Please wait...");
        jPanel3.add(label1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 570, -1));
