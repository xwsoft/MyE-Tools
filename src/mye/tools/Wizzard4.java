 ...
 */
public class Wizzard4 extends AbstractWin implements Runnable {
    ...
    public void run() {
        while(flagwhile){
            if(this.jProgressBar1.getValue()<this.jProgressBar1.getMaximum()){
                ...
                MyETools.wizzard5.setVisible(true);
                MyETools.wizzard5.initI18N();
            }
    ...
    public void initI18N(){
        ...
        String wizard4_title1 = resUtil.getResource("wizard4_title1");
        
        lb_wizard.setText(wizard);
        lb_title1.setText(wizard4_title1);
    ...
    private void initComponents() {
        ...
        jPanel3.add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 197, -1));
        ...
        lb_title1.setText("The Gateway is rebooting for the configuration to take effect. It takes about 10 seconds. Please wait...");
        jPanel3.add(lb_title1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 560, -1));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(143, 68, 580, 360));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Wizzard4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
